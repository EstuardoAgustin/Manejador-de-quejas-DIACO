...
<body>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">ADMINISTRAR UBICACIONES</a></li>
                            ...
                            <form class="form-horizontal" method="post" id="formUsuarios" name="formUsuarios"><!-- le asigna un identificador al formulario para generar un post y enviar los datos  -->
                                  ...
                                  <div id="stepFormContent">
                                    ...
                                    <div id="bloqueUsuarios" class="active"> <!-- asigna un id al bloque donde estan los campos de nuevo Cliente proveedor-->
                                      ...
                                      <div class="row">
                                        <div class="col-md-6">
                                          ...
                                          <div class="js-form-message mb-6">
                                              ...
                                              <button type="button" class="btn btn-custon-rounded-three btn-primary" name="verUsuarios" id="verDepartamentos">Ver Departamentos</button>
                                              </div>
                                          </div>
                                          <!-- End Input -->
                                        </div>
                                        <div class="col-md-6">
                                          ...
                                          <div class="js-form-message mb-6">
                                              ...
                                              <div class="js-focus-state input-group form">
                                              <button type="button" class="btn btn-custon-rounded-two btn-primary" name="verRoles" id="verMunicipios">Ver Municipios</button>
                                              </div>
                                          </div>
                                          <!-- End Input -->
                                        </div>
                                      ...
                                      <div class="row" id="divtodoDepartamentos" style="display: block">
                                          <div id="myTabContent" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 responsive-mode tab-content-center table-responsive-md justify-center" >
                                              ...
                                              <br>
                                             <table class="table  table-condensed table-hover table-responsive-md  justify-center " id="tablaDepartamentos">
                                                <thead >
                                                ...
                                                <tbody>
                                                  <?php 
                                                  $query_select = mysqli_query($conexionbd,"SELECT id_departamento, region,departamento FROM todosDepartamentos;");
                                                  ...
                                                  <?php
                                                    if ($num_rows > 0) {
                                                      ...
                                                      ?>          
                                                              ...
                                                              <tr>
                                                              <td class="text-center"><?php echo $row['id_departamento']?></td>
                                                              <td class="text-center"><?php echo $row['region'];?></td>
                                                              <td class="text-center"><?php echo utf8_encode($row['departamento'])?></td>
                                      ...
                                      <div class="row" id="divMunicipios" style="display: none">
                                          <div id="myTabContent" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 responsive-mode tab-content-center table-responsive-md justify-center" >
                                            <!-- Billing Form -->
                                            <div class="row">
                                                <div class="col-md-4">
                                            ...
                                            <br>
                                            <table class="table  table-condensed table-hover table-responsive-md  justify-center " id="tablaMunicipios">
                                                <thead >
                                                    <tr class="bgcolor btn-facebook">									
                                                ...
                                                <tbody>
                                                  <?php 
                                                  $query_select = mysqli_query($conexionbd,"SELECT id_municipio,departamento,municipio FROM todasUbicaciones;");
                                                  $num_rows = mysqli_num_rows($query_select);
                                                  ?>
                                                  <?php
                                                    if ($num_rows > 0) {
                                                      ...
                                                      ?>          
                                                              ...
                                                              <tr>
                                                              <td class="text-center"><?php echo $row['id_municipio']?></td>
                                                              <td class="text-center"><?php echo utf8_encode($row['departamento'])?></td>
    ...
    <script type="text/javascript" src="jq/2Ubicaciones.js">  </script> 
